...
public class Base64Util {
    ...
    private static Logger logger = LoggerFactory.getLogger(com.allurejava.util.Base64Util.class);
     ...
     * @return
     */
    public static boolean base64ToImage(String imgStr, String imgFilePath, String imgName) {
        // 图像数据为空
        if (StrUtils.isBlank(imgStr)) {
            return false;
        }
        try {
            // Base64解码
